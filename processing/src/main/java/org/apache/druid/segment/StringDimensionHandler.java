...
public class StringDimensionHandler implements DimensionHandler<Integer, int[], String>
{
  ...
  public StringDimensionHandler(String dimensionName, MultiValueHandling multiValueHandling, boolean hasBitmapIndexes, boolean hasSpatialIndexes, boolean enableInMemoryBitmap)
  {
  ...
  {
    return new StringDimensionIndexer(multiValueHandling, hasBitmapIndexes, hasSpatialIndexes, enableInMemoryBitmap);
  }
