...
public class SegmentManagerBroadcastJoinIndexedTableTest extends InitializedNullHandlingTest
{
  ...
  public void testLoadMultipleIndexedTableOverwrite() throws IOException, SegmentLoadingException
  {
    ...
    Assert.assertTrue(segmentManager.loadSegment(segment1, false, SegmentLazyLoadFailCallback.NOOP, null));
    Assert.assertTrue(segmentManager.loadSegment(segment2, false, SegmentLazyLoadFailCallback.NOOP, null));
  ...
  public void testLoadMultipleIndexedTable() throws IOException, SegmentLoadingException
  {
    ...
    Assert.assertTrue(segmentManager.loadSegment(createSegment(data, interval, version), false, SegmentLazyLoadFailCallback.NOOP, null));
    Assert.assertTrue(joinableFactory.isDirectlyJoinable(dataSource));
    ...
    Assert.assertTrue(segmentManager.loadSegment(createSegment(data2, interval2, version2), false, SegmentLazyLoadFailCallback.NOOP, null));
