...
public class DruidNodeTest
{
  ...
  public void testSerde1() throws Exception
  {
    DruidNode actual = mapper.readValue(
        mapper.writeValueAsString(new DruidNode("service", "host", true, 1234, null, 5678, true, true, false)),
        DruidNode.class
    );
  ...
  {
    DruidNode actual = mapper.readValue(
        mapper.writeValueAsString(new DruidNode("service", "host", false, 1234, null, 5678, null, false, false)),
        DruidNode.class
    );
    Assert.assertEquals("service", actual.getServiceName());
    Assert.assertEquals("host", actual.getHost());
  ...
  {
    DruidNode actual = mapper.readValue(
        mapper.writeValueAsString(new DruidNode("service", "host", true, 1234, null, 5678, false, true, false)),
        DruidNode.class
    );
    Assert.assertEquals("service", actual.getServiceName());
    Assert.assertEquals("host", actual.getHost());
  ...
  public void testDeserialization1() throws Exception
  {
    ...
    Assert.assertEquals(new DruidNode("service", "host", true, 1234, null, 5678, true, true, false), actual);
  ...
  public void testDeserialization2() throws Exception
  {
    ...
    DruidNode actual = mapper.readValue(json, DruidNode.class);
    Assert.assertEquals(new DruidNode("service", "host", false, 1234, null, 5678, true, false, false), actual);
  ...
  public void testDeserialization3() throws Exception
  {
    ...
    DruidNode actual = mapper.readValue(json, DruidNode.class);
    Assert.assertEquals(new DruidNode("service", "host", false, 1234, null, 5678, null, false, false), actual);
  ...
  public void testDeserialization4() throws Exception
  {
    ...
    DruidNode actual = mapper.readValue(json, DruidNode.class);
    Assert.assertEquals(new DruidNode("service", "host", false, null, 1234, 5678, null, false, false), actual);
