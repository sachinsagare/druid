...
public class DataSegment implements Comparable<DataSegment>, Overshadowable<DataSegment>
{
  ...
  public DataSegment(
          ...
          Integer binaryVersion,
          long size,
          PruneSpecsHolder pruneLoadSpecHolder
  )
  {
    this(
            dataSource,
  ...
  private List<String> prepareDimensionsOrMetricsOrAvailableSupplimentalIndexes(@Nullable List<String> list, Interner<List<String>> interner)
  {
    if (list == null) {
