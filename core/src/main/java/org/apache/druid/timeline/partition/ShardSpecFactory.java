...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(name = "bloomfilter_named_numbered_overwrite", value = BloomFilterNameNumberedOverwriteShardSpecFactory.class),
    ...
    @JsonSubTypes.Type(name = "stream_fanout_named_hashed", value = StreamFanOutNamedHashBasedNumberedShardSpecFactory.class),
})
