...
public class StreamFanOutHashBasedNumberedShardSpecFactory implements ShardSpecFactory
{
  ...
  private static final StreamFanOutHashBasedNumberedShardSpecFactory
      INSTANCE = new StreamFanOutHashBasedNumberedShardSpecFactory();
  @JsonIgnore
  ...
  public static StreamFanOutHashBasedNumberedShardSpecFactory instance()
  {
    return INSTANCE;
  }

  private StreamFanOutHashBasedNumberedShardSpecFactory()
  {
  ...
  public StreamFanOutHashBasedNumberedShardSpecFactory(
