...
public class LongsSketchJsonSerializer extends JsonSerializer<LongsSketchWrap>
{
  @Override
  public void serialize(final LongsSketchWrap sketch, final JsonGenerator jgen, final SerializerProvider provider)
      throws IOException
  {
