...
public class IndexedBasedLongsSketchColumn implements ComplexColumn
{
  private final LongsSketchColumnIndexed index;
  private final String typeName;

  public IndexedBasedLongsSketchColumn(String typeName, LongsSketchColumnIndexed index)
  {
    this.index = index;
