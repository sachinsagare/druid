...
final class PreambleUtil
{
  ...
  public static String preambleToString(final Memory srcMem)
  {
    ...
    final String flagsStr = com.yahoo.sketches.Util.zeroPad(Integer.toBinaryString(flags), 8) + ", " + (flags);
    ...
    sb.append(com.yahoo.sketches.Util.LS)
        .append("### FREQUENCY SKETCH PREAMBLE SUMMARY:").append(com.yahoo.sketches.Util.LS)
        .append("Byte  0: Preamble Longs: ").append(preLongs).append(com.yahoo.sketches.Util.LS)
        .append("Byte  1: Serialization Version: ").append(serVer).append(com.yahoo.sketches.Util.LS)
        .append("Byte  2: Family: ").append(family.toString()).append(com.yahoo.sketches.Util.LS)
        .append("Byte  3: MaxMapSize: ").append(maxMapSize).append(com.yahoo.sketches.Util.LS)
        .append("Byte  4: CurMapSize: ").append(curMapSize).append(com.yahoo.sketches.Util.LS)
        .append("Byte  5: Flags Field: ").append(flagsStr).append(com.yahoo.sketches.Util.LS)
        .append("  EMPTY: ").append(empty).append(com.yahoo.sketches.Util.LS)
        .append("Byte  6: Freq Sketch Type: ").append(type).append(com.yahoo.sketches.Util.LS);

    if (preLongs == 1) {
      sb.append(" --ABSENT, ASSUMED:").append(com.yahoo.sketches.Util.LS);
    } else { //preLongs == maxPreLongs
      sb.append("Bytes 8-11 : ActiveItems: ").append(activeItems).append(com.yahoo.sketches.Util.LS);
      sb.append("Bytes 16-23: StreamLength: ").append(streamLength).append(com.yahoo.sketches.Util.LS)
          .append("Bytes 24-31: Offset: ").append(offset).append(com.yahoo.sketches.Util.LS);
    }

    sb.append("Preamble Bytes: ").append(preLongs * 8).append(com.yahoo.sketches.Util.LS);
    sb.append("TOTAL Sketch Bytes: ").append((preLongs + (activeItems * 2)) << 3)
        .append(com.yahoo.sketches.Util.LS)
        .append("### END FREQUENCY SKETCH PREAMBLE SUMMARY").append(com.yahoo.sketches.Util.LS);
    return sb.toString();
  }
  ...
  static int extractActiveItems(final long pre1)
  { //Bytes 8 to 11
  ...
  static long insertActiveItems(final int activeItems, final long pre1)
  { //Bytes 8 to 11
    final long mask = 0XFFFFFFFFL;
